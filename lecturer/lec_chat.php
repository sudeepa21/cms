...
<head>
    <meta charset="UTF-8">
    <title>Lecture Chat | Smart Campus</title>
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="chat-header">
                        <h5><i class="fas fa-comments"></i> Lecture Chat Room</h5>
                    </div>
...
$(document).ready(function() {
    ...
    function loadMessages() {
        if (selectedBadgeId) {
            $.get("lec_get_messages.php?receiver_badge_id=" + selectedBadgeId, function(data) {
