...
$student_id = htmlspecialchars($_SESSION['user_id']); // Sanitize student ID
...
<div class="student-header">
    <div class="left">
        ...
        <span class="student-id">Student ID: <?php echo $student_id; ?></span>
    </div>
    <div class="right">
        <div class="profile-section">
            <img src="<?php echo $profile_image_path; ?>" alt="Student Profile" class="profile-icon">
...
.student-header {
    background-color: #800020; /* Blue background for students */
    color: white;
    padding: 15px 30px;
