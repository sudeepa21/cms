...
// Fetch the logged-in student's user_id from the session
...
if ($result->num_rows === 1) {
    ...
    die("Error: Student profile not found for user_id = $user_id");
}
...
<head>
    ...
    <title>Student Profile | Smart Campus</title>
...
<body>
        ...
        <form id="profileForm" class="bg-white p-4 rounded shadow-sm" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-12 text-center">
                    <?php if (!empty($student['profile_picture'])): ?>
                        <img src="../uploads/<?php echo htmlspecialchars($student['profile_picture']); ?>" alt="Profile Picture" class="profile-picture">
                    <?php else: ?>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <input type="text" id="uni_ID" class="form-control" value="<?php echo htmlspecialchars($student['uni_ID']); ?>" readonly>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <input type="text" id="username" class="form-control" value="<?php echo htmlspecialchars($student['username']); ?>" readonly>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <input type="text" id="mobile" name="mobile" class="form-control" value="<?php echo htmlspecialchars($student['mobile']); ?>" required>
    ...
    $(document).ready(function() {
        ...
        $("#profileForm").submit(function(e) {
            ...
            $.ajax({
                url: "update_student_profile.php",
                type: "POST",
                data: formData,
                processData: false,
                contentType: false,
        ...
        $("#removeProfilePicture").click(function() {
            if (confirm("Are you sure you want to remove your profile picture?")) {
                $.post("update_student_profile.php", { remove_profile_picture: true }, function(response) {
                    if (response.status === "success") {
                        $("#statusMessage").text(response.message).css("color", "green");
