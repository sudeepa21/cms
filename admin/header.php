...
$admin_id = htmlspecialchars($_SESSION['user_id']); // Sanitize admin ID
...
<div class="admin-header">
    <div class="left">
        ...
        <span class="admin-id">Admin ID: <?php echo $admin_id; ?></span>
    </div>
    <div class="right">
        <div class="profile-section">
            <img src="<?php echo $profile_image_path; ?>" alt="Admin Profile" class="profile-icon">
